...
Write a spec to .pipeline/spec.md containing: Files to create or modify, with exact paths. The interface or function signatures needed.
Edge cases the implementation must handle. Which existing patterns to follow (name the file to copy from).
